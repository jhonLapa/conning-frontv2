...
import ActionsCategoria from "./action-categoria";
...
export const getColumns = (refreshDataTable: () => void): ColumnDef<Categoria>[] => [
  {
    id: "name",
    header: ({ column }) => {
  ...
  },
  {
    id: "actions",
    cell: ({ row }) => (
      <ActionsCategoria categoria={row.original} onRefresh={refreshDataTable} />
    ),
  },
];

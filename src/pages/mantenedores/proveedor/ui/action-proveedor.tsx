  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        >
          <Copy size={18} />
          <span className="text-sm ml-2">Copiar ID del proveedor</span>
        </DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem>
          <Link
            to={`/proveedor/${proveedor.idProveedor}`}
          ...
          <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Esta acción
                  {proveedor.estado === 1 ? "desactivara" : "activara"} al proveedor
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  onClick={() => {
                    handleChangeStatus(proveedor.idProveedor);
                  }}
                  disabled={isLoading}
                  className="gap-2"
                >
